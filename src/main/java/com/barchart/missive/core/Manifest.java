 ...
 * 
 * @param <M>
 *            the extended base class of the classes represented in the
 *            manifest.
 */
@SuppressWarnings("serial")
public class Manifest<M extends TagMap> extends
		HashMap<Class<? extends M>, Tag<?>[]> {

	public Manifest() {
	}

	public List<Class<? extends M>> orderedClasses() {
		final List<Class<? extends M>> classes = new ArrayList<Class<? extends M>>(
				this.keySet());
	...
	private static class TypeComparator implements
			Comparator<Class<? extends TagMap>> {
